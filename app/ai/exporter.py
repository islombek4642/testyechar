...
class AIExporter:
    ...
    def to_stats_report_string(self, stats: AIStatistics) -> str:
        ...
        lines = [
            ...
            "",
            "  — Tokenlar (taxminiy) —",
            f"  Kiritish tokenlar   : {stats.estimated_input_tokens:,}",
            f"  Chiqish tokenlar    : {stats.estimated_output_tokens:,}",
            f"  Jami tokenlar       : {stats.estimated_total_tokens:,}",
            "",
            "  — Narx (taxminiy) —",
            f"  Standart API narxi  : ${stats.estimated_cost_standard_usd:.4f}",
            f"  Batch API narxi     : ${stats.estimated_cost_batch_usd:.4f}",
            "",
